...
SDK Explorer is a sample app that demonstrates the features available for use in the Salesforce Marketing Cloud [JB4A-SDK](https://github.com/salesforcefuel/JB4A-SDK-iOS). See the [Implemented SDK Features](#implemented) section below for a full list of the features that are implemented.
...
- [Tags](http://salesforcefuel.github.io/JB4A-SDK-iOS/features/tags.html)
- [Attributes](http://salesforcefuel.github.io/JB4A-SDK-iOS/features/attributes.html)
- [Push Messages](https://code.exacttarget.com/api/messagecontact-send-0) (via Fuel REST Route)
- [Custom Alert Sound](http://salesforcefuel.github.io/JB4A-SDK-iOS/features/custom-sound.html)
- [OpenDirect](http://salesforcefuel.github.io/JB4A-SDK-iOS/features/opendirect.html)
- [Custom Key](http://salesforcefuel.github.io/JB4A-SDK-iOS/features/custom-keys.html)
- [Location Messages](http://salesforcefuel.github.io/JB4A-SDK-iOS/location/geolocation.html)
- [CloudPages](http://salesforcefuel.github.io/JB4A-SDK-iOS/rich-push/rich-push-overview.html)
- [CloudPage Inbox](http://salesforcefuel.github.io/JB4A-SDK-iOS/rich-push/rich-push-inbox.html)

...
static NSString * const kDidReceiveLocationNotification = @"ETEventBusDidReceiveLocationNotification";
...
-(void)configureSDKWithAppID:(NSString *)etAppID
         ...
         andLocationServices:(BOOL)locState
               andCloudPages:(BOOL)cpState DEPRECATED_MSG_ATTRIBUTE("The method is deprecated");
...
-(BOOL)configureSDKWithAppID:(NSString *)etAppID
         ...
         andLocationServices:(BOOL)locState
             ...
             withPIAnalytics:(BOOL)pIAnalyticsState
                       error:(NSError **)configureError DEPRECATED_MSG_ATTRIBUTE("The method is deprecated");
...
/**
 ...
 @return - No value returned.
 */
+(void) setLoggerWithHandler:(void (^)(NSString *))customLogger;
 ...
 */
- (BOOL) refreshWithFetchCompletionHandler:(void (^)(UIBackgroundFetchResult result))completionHandler;

 ...
 */
@property (nonatomic, copy, readonly, nullable) NSString *messageIdentifier ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSString *alert ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSString *badge ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSArray *keyValuePairs ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSString *siteIdentifier ;

/** 
 The Site URL for the ClouePage attached to this message. It is saved as an NSString and converted later to NSURL.
  
 */
@property (nonatomic, copy, readonly, nullable) NSString *siteUrlAsString ;

/**
 OpenDirect payload for this message, if there is one. 
  
 */
@property (nonatomic, copy, readonly, nullable) NSString *openDirectPayload ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSNumber *messageLimit ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSNumber *messagesPerPeriod ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSNumber *numberOfPeriods ;
 ...
 */
@property (nonatomic, copy, readonly, nullable) NSNumber *minTripped ;
